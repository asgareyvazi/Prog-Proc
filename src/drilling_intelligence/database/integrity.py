...
_PROMOTED_MODELS: tuple[type, ...] = (
    ...
    ProcedureRecord,
    DrillingProgram,
    # A calculation record cites a method and, since 0005, a document version: an engineering number read
    # out of a file has to be able to show the file, which is the same rule as every other row here.
    Calculation,
)
