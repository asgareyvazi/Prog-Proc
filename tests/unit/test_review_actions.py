...
def test_capabilities_are_derived_and_do_not_offer_historical_or_unbacked_approval(workspace) -> None:
    ...
    assert "approve" not in {
        action.action_id for action in service.available_actions(unbacked)
    }
